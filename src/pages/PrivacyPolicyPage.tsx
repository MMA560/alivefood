...
import { ArrowLeft, ArrowRight, Shield, User, Eye, CreditCard, Share2, Database, UserCheck, Trash2, RefreshCw, Phone } from 'lucide-react';
...
const PrivacyPolicyPage = () => {
  ...
  const translations = {
    en: {
      title: 'Privacy Policy - Sawa Mob Store',
      ...
      dataCollectionText: 'At Sawa Mob Store, we collect the following data only:',
      fullName: 'Full Name',
      ...
      noMarketing: 'We do not use data for marketing purposes or promotional messages',
      noSelling: 'We do not sell or rent your data to any third parties',
      
      trackingText: 'We use tracking tools to monitor visited pages on the website',
      trackingPurpose: 'Tracking is used only to improve targeting and user experience',
      ...
      financialProtectionText: 'We do not store credit card or e-wallet information',
      securePayments: 'All financial transactions are processed through secure platforms of approved banks and companies',
      highSecurity: 'We use the highest security standards in payment processing',
      ...
      dataStorageText: 'We retain your data for 2 months from the last order date',
      secureServers: 'Data is stored on secure external servers',
      securityPractices: 'We follow best security practices to protect your data',
      ...
      deleteRequestText: 'To contact us regarding data deletion or modification:',
      whatsapp: 'WhatsApp: 01001225846',
      email: 'Email: Aymanfaam@gmail.com',
      phone: 'Phone: 01001225846',
      ...
      continuedUse: 'Continued use of the website means you agree to the updated policy',
      
      consentText: 'By using Sawa Mob Store website, you agree to the collection and use of your data according to this policy.',
    ...
    ar: {
      title: 'سياسة الخصوصية - متجر سوا موب',
      ...
      dataCollectionText: 'نحن في متجر سوا موب نجمع البيانات التالية فقط:',
      ...
      facebookPixel: 'نستخدم Facebook Pixel لتحسين الإعلانات والحصول على احصائيات',
      
      financialProtectionText: 'لا نحفظ معلومات البطاقات الائتمانية أو المحافظ الإلكترونية',
      securePayments: 'جميع المعاملات المالية تتم عبر المنصات الآمنة للبنوك والشركات المعتمدة',
      ...
      whatsapp: 'واتساب: 01001225846',
      email: 'إيميل: Aymanfaam@gmail.com',
      phone: 'هاتف: 01001225846',
      ...
      consentText: 'باستخدام موقع متجر سوا موب، فإنك توافق على جمع واستخدام بياناتك وفقاً لهذه السياسة.',
      
      lastUpdated: 'تاريخ آخر تحديث: 10 يوليو 2025',
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-bold text-gray-800">{t('dataCollection')}</h2>
            </div>
            ...
            <ul className="space-y-3 text-gray-700">
              ...
              <li className="flex items-start gap-2">
                <span className="text-blue-600 mt-1 font-bold">•</span>
                <span><strong>{t('phoneNumber')}</strong></span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-600 mt-1 font-bold">•</span>
                <span><strong>{t('deliveryAddress')}</strong></span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-bold text-gray-800">{t('dataUsage')}</h2>
            </div>
            <ul className="space-y-3 text-gray-700">
              <li className="flex items-start gap-2">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-bold text-gray-800">{t('trackingCookies')}</h2>
            </div>
            <ul className="space-y-3 text-gray-700">
              <li className="flex items-start gap-2">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-bold text-gray-800">{t('financialDataProtection')}</h2>
            </div>
            <ul className="space-y-3 text-gray-700">
              <li className="flex items-start gap-2">
                <span className="text-red-600 mt-1">•</span>
                <span><strong>{t('financialProtectionText')}</strong></span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-red-600 mt-1">•</span>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-bold text-gray-800">{t('dataSharing')}</h2>
            </div>
            <p className="text-gray-700 mb-4">{t('dataSharingText')}</p>
            <ul className="space-y-3 text-gray-700">
              <li className="flex items-start gap-2">
                <span className="text-orange-600 mt-1">•</span>
                <span><strong>{t('deliveryCompanies')}</strong></span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-orange-600 mt-1">•</span>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-bold text-gray-800">{t('dataStorage')}</h2>
            </div>
            <ul className="space-y-3 text-gray-700">
              <li className="flex items-start gap-2">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-bold text-gray-800">{t('userRights')}</h2>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-bold text-gray-800">{t('dataDeleteRequest')}</h2>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-bold text-gray-800">{t('policyUpdates')}</h2>
            </div>
            <ul className="space-y-3 text-gray-700">
              <li className="flex items-start gap-2">
          ...
          <div className="bg-blue-50 rounded-lg p-6 mb-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-bold text-blue-800">{t('consent')}</h2>
            </div>
          ...
          <div className="bg-gray-100 rounded-lg p-4 mb-8">
            <p className="text-sm text-gray-600 text-center font-medium">{t('lastUpdated')}</p>
          </div>
